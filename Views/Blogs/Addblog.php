  ...
  <form action="/Blogs/AddBlog" method="POST" class="mx-auto mt-10 max-w-xl sm:mt-10">
    ...
    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
      ...
      <div class="sm:col-span-2">
        ...
        <div class="mt-1.5">
          <textarea name="article" id="article" rows="4" class="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 border-2 -outline-offset-1 order-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600"><?= isset($old['article']) ? htmlspecialchars($old['article']) : '' ?></textarea>
        </div>
    ...
    <div class="mt-5 flex justify-center">
      <button type="submit" class="flex justify-center w-[20%] rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-l font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Add</button>
    </div>
  </form>
</div>
