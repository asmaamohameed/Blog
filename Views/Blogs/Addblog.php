...
<!-- <div class="absolute inset-x-0 top-[0rem] sm:top-[0rem] -z-10 transform-gpu overflow-hidden blur-3xl" aria-hidden="true">
  ...
  <form action="/Blogs/Create" method="POST" class="mx-auto mt-10 max-w-xl sm:mt-10">

    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">  
      <div class="sm:col-span-2">
        <label for="Title" class="block text-sm/6 font-semibold text-gray-900">Title</label>
        <div class="mt-1.5">
          <input type="text" name="title" id="title" autocomplete="organization" class="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600">
        </div>
      </div>
      <div class="sm:col-span-2">
      ...
      <div class="sm:col-span-2">
        <label for="article" class="block text-sm/6 font-semibold text-gray-900">Artical</label>
        <div class="mt-1.5">
          <textarea name="article" id="article" rows="4" class="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600"></textarea>
        </div>
      </div>
    </div>
    <div class="mt-5 flex justify-center">
      <button type="submit" class="flex justify-center w-45 rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-l font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Add</button>
    </div>
  </form>
</div>
